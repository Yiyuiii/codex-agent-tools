...
- 新增：`plugins/cache/codex-external-agents-local/codex-external-agents/0.1.1-beta.1/.codex-plugin/plugin.json`、`plugins/cache/codex-external-agents-local/codex-external-agents/0.1.1-beta.1/.mcp.json`、`plugins/cache/codex-external-agents-local/codex-external-agents/0.1.1-beta.1/runtime/codex-external-agents-mcp.mjs`
- 变化：`config.toml`
- 删除：无
...
- 新增：无
- 变化：`config.toml`
- 删除：`plugins/cache/codex-external-agents-local/codex-external-agents/0.1.1-beta.1/.codex-plugin/plugin.json`、`plugins/cache/codex-external-agents-local/codex-external-agents/0.1.1-beta.1/.mcp.json`、`plugins/cache/codex-external-agents-local/codex-external-agents/0.1.1-beta.1/runtime/codex-external-agents-mcp.mjs`
