# codex-agent-tools 0.1.2-beta.1 公共 npm 隔离验收

## 制品身份

- 验收时间：`2026-08-23T12:15:12.020Z`
- 公共包：`codex-agent-tools@0.1.2-beta.1`
- npm integrity：`sha512-/YOYuIBQRPrEAf3cV+DJqBRfHxr9dhLjS/LESVQ/tKg12OidqIp+HbioqEegH4IgfUPaBuut2it42xrlcn3AOg==`
- npm shasum：`e24fae9938a272913ac6b0349a1881476c90024d`
- Node.js：`v24.14.1`
- npm：`11.11.0`
