...
> 2026-07-29 适用说明：本文关于真实调用默认授权、批次身份、首错停止与证据保留的边界继续有效；“同批 8/8 才能晋级”的旧产品资格规则已被[能力粒度资格设计](2026-07-29-capability-scoped-qualification-design.md)取代。历史段落保留用于解释当时决策，不应覆盖当前能力索引。
