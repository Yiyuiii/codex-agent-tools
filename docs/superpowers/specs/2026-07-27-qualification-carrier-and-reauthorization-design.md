...
> 历史状态说明（2026-07-28）：本文记录当时的一次性人工授权边界。维护者现已用 [standing authorization](2026-07-28-standing-experiment-authorization-design.md) 取代未来逐批/逐 SHA 人工许可；本文的 one-cell、长时承载、fail-closed 和证据完整性要求仍有效。
